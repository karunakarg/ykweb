...
<form action="editad.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
  ...
  <table width="613" border="0" cellspacing="2">
    ...
    <tr>
      ...
      <a href="<?=kbase()?>/index.php?option=com_content&view=article&id=32&q=&country=<?=$section?>&state=<?=$category?>" target="_blank" style="text-decoration:none"><?=getcat($category)?>
...
<td colspan="2"><a href="<?=kbase()?>/index.php?option=com_content&view=article&id=30&gid=<?=$grp['id']?>" target="_blank"><?=$grp['name']?></a></td>
    </tr>
    <tr>
