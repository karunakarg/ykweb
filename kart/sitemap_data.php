...
if($num)
{
	...
	for($i=$startpoint;$i<$lim;$i++)
	{
        ...
        <td width="624" colspan="2"><a href="../index.php/component/content/article/<?=$roww['alias']?>/?id=<?=$artid?>"><?=$roww['title']?></a></td>
      </tr>
      <?
	  			$sno++;
			}
...
else
{
	...
	?>
    <a href="index.php?option=com_wrapper&view=wrapper&Itemid=94">Post a request for this Item</a></br></br>
    <?
}
