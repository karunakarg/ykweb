...
?>
	...
	?>
     ...
     <a href="../index.php?option=com_content&view=article&id=32&q=&country=<?=$row['section']?>&state=<?=$row['category']?>" target="_parent" style="text-decoration:none"><?=getcat($row['category'])?></a></font></td>
      </tr>
	      <tr>
	        <td width="144"><hr  /></td>
	        <td colspan="2"><hr  /></td>
...
<p>
  <?
//******************************************************PAGINATION **************************
echo pagination($st,$limit,$page,$url='?gid='.$gid.'&');
/////////////////////////////////////////////////////////////////////////////////////////////
